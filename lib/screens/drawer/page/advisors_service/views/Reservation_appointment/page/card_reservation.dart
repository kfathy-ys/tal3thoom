...
class ReservationsCard extends StatelessWidget {
  ...
  const ReservationsCard({Key? key, required this.specialistName, required this.sessionDate, required this.start, required this.end, required this.onTap}) : super(key: key);
    ...
    return CustomContainer(
      ...
      child: Column(
        ...
        children: [
           ...
           CardItems(
              title: "تاريخ الجلسة", subTitle: sessionDate),
