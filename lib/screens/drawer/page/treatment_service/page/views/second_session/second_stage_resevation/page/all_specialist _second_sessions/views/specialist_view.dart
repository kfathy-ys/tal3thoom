...
class _AllSpecialistsSecondSessionsState
    extends State<AllSpecialistsSecondSessions> {
  @override
  Widget build(BuildContext context) {
    BlocProvider.of<AllSpecialistSecondSessionsCubit>(context)
        .getSpecialistsSecondStage(
            ...
            children: [
              ...
              BlocConsumer<AllSpecialistSecondSessionsCubit,
                ...
                builder: (context, state) {
                  final cubit =
                      BlocProvider.of<AllSpecialistSecondSessionsCubit>(
                          context);
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          MediaButton(
                                            onPressed: () {
                                              cubit
                                                  .secondStagesSessionsCreateReservation(
                                                      specialistId: state
                                                          .allSpecialistModel
                                                          .data[index]
                                                          .id);
