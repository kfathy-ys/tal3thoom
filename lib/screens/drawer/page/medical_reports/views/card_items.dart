...
class CardItems extends StatelessWidget {
  ...
  const CardItems({Key? key,
    required this.onPressed, required this.subTitleReportName,
    required this.subTitleSpecialistName, required this.subTitleDate}) : super(key: key);
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          CustomButton(title: "عرض التقرير",color: kPrimaryColor,onPressed: onPressed,)
        ],
      ),
    );
  }
