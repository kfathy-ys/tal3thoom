...
List<CheckBoxItem> firstQuestionsList = [
  ...
  CheckBoxItem(
      ...
      answersList: [
        ...
        {"name": KeysConfig.another , "value": "other",},
      ]),
  CheckBoxItem(
      onTap:()=>  speech.speak(KeysConfig.studyingPrivatePublicSchool ),
...
List<CheckBoxItem> forthQuestionsList = [
  ...
  CheckBoxItem(
      ...
      name: "أثناء القراءةْ", selectedValue: "", answersList: [
    {"name": "زيادة", "value": "1"},
    {"name": "نقصان", "value": "2"},
    {"name": "متقلب", "value": "3"},
    {"name": "ثابت", "value": "4"},
  ...
  CheckBoxItem(
      ...
      name: "من فضلك حدِّدْ :", selectedValue: "", answersList: [
    {"name": "لا", "value": "1"},
    {"name": "نعم ", "value": "2"},
  ]),
  CheckBoxItem(
  ...
  CheckBoxItem(
      ...
      name: "من فضلك حدد", selectedValue: "", answersList: [
    {"name": "لا", "value": "1"},
    {"name": "نعم ", "value": "2"},
  ]),
  CheckBoxItem(
...
List<CheckBoxItem> fifthQuestionsList = [
  CheckBoxItem(
      ...
      name: "صِفْ إن كانت هناك كلماتٌ معينةْ صعبةُ النطقْ فيتم استخدام كلمات بديلة مِثلْ : طريقْ بدلاً مِنْ شارعْ و هكذا",
      selectedValue: "",
      answersList: [
        {"name": "لا", "value": "1"},
        {"name": "نعم ", "value": "2"},
  ...
  CheckBoxItem(
      ...
      name: "هل تتجنب مواقف معينة مثل عدم حضور عشاءٍ كبير فيه الكثير من الحضورْ؟",
      selectedValue: "",
      answersList: [
        {"name": "لا", "value": "1"},
        {"name": "نعم ", "value": "2"},
...
List<CheckBoxItem> sixQuestionsList = [
  ...
  CheckBoxItem(
      ...
      name: "هل التلعثم لديك مطول أو متقطع أو يوجد إضطرابٌ داخل الصوت أو يضيف كلماتٍ إضافيةٍ في بداية الجملة؟",
      selectedValue: "",
      answersList: [
        {"name": " متكرر", "value": "1"},
        {"name": "مطول", "value": "2"},
  ...
  CheckBoxItem(
      ...
      name: "هل تحاول في الكلمة المتلعثم فيها مرة أخرى؟", selectedValue: "", answersList: [
    {"name": "لا", "value": "1"},
    {"name": "نعم ", "value": "2"},
  ]),
  CheckBoxItem(
