          ...
          DefaultTextStyle(
            ...
            child: AnimatedTextKit(
              animatedTexts: [
                ...
                TyperAnimatedText(
                  "يرجاء الضغط علي زر المتابعه 👇",textStyle:buildAccentTextStyle(),
                ),
                TyperAnimatedText( " لتاكيد عملية الدفع",textStyle:buildAccentTextStyle()),
                TyperAnimatedText("حيث يمكنك التاكد من خلال ",textStyle: buildAccentTextStyle()),
                TyperAnimatedText( "قائمة التطبيق بالاشارة الي تم",textStyle: const TextStyle(
                    color: kButtonRedDark, fontSize: 20, fontFamily: 'DinBold')),
              ],
