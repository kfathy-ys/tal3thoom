          ...
          DefaultTextStyle(
            ...
            child: AnimatedTextKit(
              animatedTexts: [
                ...
                TyperAnimatedText(
                  "يرجاء عند رفع الفيديو المسجل",textStyle:buildAccentTextStyle(),
                ),
                TyperAnimatedText( "الالتزام بالقواعد التالية",textStyle:buildAccentTextStyle()),
                TyperAnimatedText("لابد حجم الفيديو المسجل",textStyle: buildAccentTextStyle()),
                TyperAnimatedText( "لا يتجاوز 2 ميغا بايت",textStyle: const TextStyle(
                    color: kButtonRedDark, fontSize: 20, fontFamily: 'DinBold'),),
              ],
