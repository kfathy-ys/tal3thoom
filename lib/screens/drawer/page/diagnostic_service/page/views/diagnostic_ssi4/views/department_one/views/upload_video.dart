...
class CardUploadVideo extends StatelessWidget {
  ...
  const CardUploadVideo({Key? key, required this.height, required this.title, this.validator, required this.controller, required this.onPressed1, required this.context}) : super(key: key);
