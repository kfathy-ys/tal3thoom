...
class CustomWidgetDepartment extends StatefulWidget {
 ...
 final  OasesTestCubit cubit ;
  ...
  const CustomWidgetDepartment({Key? key, required this.cubit, required this.itemsList}) : super(key: key);
                  ...
                  return FormBuilder(
                    ...
                    child: i != widget.cubit.index
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: Center(
                                    child: customText3(title: "${widget.cubit.totalCounter}", color: kBlackText),
                                  ),
                                ),
                                const SizedBox(width: 6,),
                                Expanded(
                                  child: customText2(title: "${ widget.itemsList[
                                  widget.cubit.index].name}"
                                      , color: kBlackText),
                                )
                              ],
                            ),
                      ...
                      onChanged: (value) {
                        ...
                        if (!selectedValues
                            .contains("")) {
                          widget.cubit.isFinishedAnswered =
                          true;
                        }
                        print(value);
